...
- Active phase / 当前阶段：P2 Gemini 2 SDK 与真实 RGB-D 验收。
- Completed phase / 已完成阶段：P0 机械臂安全启动与执行门控、P1 MuJoCo 基线巩固与差距整合均已通过对应验收。
...
3. P2 从 Gemini 2 设备枚举和只读 RGB/depth 采集开始，不启动机械臂执行；
