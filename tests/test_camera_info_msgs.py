...
def test_camera_info_to_msg_preserves_rational_polynomial_coefficients():
    from rebotarm_vision.converters.image_msgs import camera_info_to_msg
    ...
    assert msg.header.frame_id == "camera_color_frame"
    assert msg.distortion_model == "rational_polynomial"
    assert list(msg.d) == [0.1, 0.2, 0.01, 0.02, 0.3, 0.4, 0.5, 0.6]
